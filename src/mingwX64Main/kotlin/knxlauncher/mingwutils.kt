...
fun WSTR.toKString(): String = memScoped {
    ...
    val sz = WideCharToMultiByte(CP_UTF8.toUInt(), WC_ERR_INVALID_CHARS.toUInt(), this@toKString, -1, null, 0, null, null)
    // Now convert to UTF-8 and from there, a String.
    val utf8 = allocArray<ByteVar>(sz)
    val r = WideCharToMultiByte(CP_UTF8.toUInt(), WC_ERR_INVALID_CHARS.toUInt(), this@toKString, -1, utf8, sz, null, null)
    if (r == 0) {
